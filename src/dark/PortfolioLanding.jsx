...
const PortfolioLanding = () => {
    let title = 'About Me',
        description = 'My expertise lies in defining and executing a design strategy that is built on a deep understanding of user and business needs and context that surrounds digital experiences—committed to high standards in all stages of a products lifecycle, from conception to design, development, and validation.';
